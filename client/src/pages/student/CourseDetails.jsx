  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p className='text-blue-600'>({courseData.courseRatings.length} {courseData.courseRatings.length > 
          1 ? 'ratings' : 'rating'})</p>

          <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students' : 'student'}</p>
        </div>

        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Educate</span></p>
          ...
          <div className='pt-5'>
            {courseData.courseContent.map((chapter, index)=> (
              <div key={index} className='border border-gray-300 bg-white rounded mb-2'>
                ...
                <div className={`overflow-hidden transiton-all duration-300 
      ...
      overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded text-white font-medium bg-blue-600 hover:bg-blue-700'>
